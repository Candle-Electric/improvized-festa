...
;       Gameplay        ;
;=======================;
Penguin_Gameplay: ; Penguin Runner Rename
...
.Collision_Chunk_2
    ...
    mov #2, collision_active
    ; Optionally, Maybe Try Assigning Based On Obstacle Type, Potentially Reserving Some Flags.
	jmpf .Collision_Done
.Collision_Chunk_3
    sub #1 ; 8
...
.Handle_Collision_Result
	...
	; mov #<Debugging_Sprite, player_sprite_sprite_address
